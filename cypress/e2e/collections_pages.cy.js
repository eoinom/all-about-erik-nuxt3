...
describe("Collections - Old-Time Sportsmen", () => {
  ...
  it("scrolling to bottom of page shows back to top static button", () => {
    cy.scrollTo("bottom", { duration: 1500 });
    cy.get("main")
      .find("#backToTopStaticDiv img")
      .should("be.visible")
      .should("have.attr", "src")
      .should("include", "back-to-top-1line-black");
  });

  it("clicking back to top static button scrolls the page to the top", () => {
    cy.get("main")
      .find("#backToTopStaticDiv")
      .click();
