  ...
  <div class="pb-5">
    ...
    >
      ...
      >
        ...
        <v-col style="max-width: calc(50% - 8px)">
          <friend-card
            :friend="friends[2]"
            :index="2"
            imgPosition="bottom"
