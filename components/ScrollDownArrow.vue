<template>
  ...
  <div
    v-scroll-to="{ el: scrollToElement, duration: 1500, easing: 'ease' }"
  ...
  >
    ...
    <p class="my-0 my-lg-1 my-xl-2">
      <img
        alt="Scroll arrow"
        src="../assets/images/arrow-full-down.png"
        id="scrollArrowImg"
      />
    </p>
  </div>
...
#scrollImg {
  max-width: 157px;
  min-width: 78.5px;
  width: calc(78.5px + 78.5 * (100vw - 250px) / (1366 - 250));
}

#scrollArrowImg {
  max-width: 38px;
  min-width: 19px;
  width: calc(19px + 19 * (100vw - 250px) / (1366 - 250));
}
</style>
